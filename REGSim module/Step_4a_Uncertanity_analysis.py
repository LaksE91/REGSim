...
filedir                 = 'C:\Users\Laks\Desktop\REGSim modified\Data' # enter the user directory
...
[lowerbound, upperbound]    = uncertain(1,input_data,input_calib,samp_set,area,lb,ub,cutoff,h_max,mv,1)
...
[lower_total, upper_total]  = uncertain(1,input_data,input_calib,samp_set,area,0,1,1,h_max,mv,1)

...
filedir                     = 'C:\Users\Laks\Desktop\REGSim-main\REGSim module\Data' # update wiith user directory
...
mv                        = 1  # model variant
pcase                     = 3 # pumping case
####### behavioural set######
[lb,ub,df_behav]                 = sim_glue(rech_case,pcase,data,input_calib,df_Psets,area,lb,ub,cutoff1,h_max,1,1)
######## non-behavioural set#####
[lb,ub,df_nbehav]                = sim_glue(rech_case,pcase,data,input_calib,df_Psets,area,lb,ub,cutoff2,h_max,1,2)
